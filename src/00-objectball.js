    ...
    for (const key in obj) {
        if (typeof obj[key] === 'object' && !Array.isArray(obj[key])) {
            ...
            if(key === playerName) {
                ...
                result = recur(obj[key], playerName);
                if(result)
...
function getPlayer(obj, playerName) {
    return recur(obj, playerName);
}
...
console.log("Reggie Evans: ", numPointsScored("Reggie Evans"));